                                        ...
                                        {pendingFees.map((fee) => {
                                            return (
                                                <button
                                                    ...
                                                    className="w-full rounded-[9px] border px-4 py-3 flex items-center justify-between text-sm shadow-sm transition-all active:scale-[0.99] bg-rose-50 border-rose-100 text-rose-800"
                                                >
