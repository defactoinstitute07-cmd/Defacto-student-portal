    ...
    if (isLoading) {
        return (
            <div className="bg-slate-50 px-5 pt-6 pb-24 no-scrollbar scroll-smooth min-h-screen">
                <Skeleton className="h-32 w-full   rounded-[10px] mb-6" />
        ...
        >
            <main className="p0">
                <section className="relative overflow-hidden rounded-[30px] border border-slate-200/80 bg-white p-5 shadow-[0_18px_45px_rgba(15,23,42,0.08)] sm:p-6">
                    <div className="absolute -right-14 -top-14 h-40 w-40   rounded-[10px] bg-blue-100/60" />
                    <div className="absolute -left-20 -bottom-20 h-48 w-48   rounded-[10px] bg-emerald-100/40" />
                    ...
                    <div className="relative">
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                            ...
                            <span className="inline-flex items-center   rounded-[10px] bg-indigo-50 px-3 py-1.5 text-[11px] font-bold tracking-wide text-indigo-700 border border-indigo-100">
                    ...
                    {['All'].map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-4 py-2   rounded-[10px] text-[12px] font-black uppercase tracking-wider transition-colors whitespace-nowrap border flex items-center gap-1.5 ${
                                    activeTab === tab
                            ...
                            >
                                ...
                                {t(tab)}
                                <span className={`ml-0.5 text-[10px]   rounded-[10px] px-1.5 py-0.5 font-black ${
                ...
                {error && (
                    <div className="mt-5   rounded-[10px] border border-red-200 bg-red-50 p-4 text-sm font-semibold text-red-600">
                        {error}
                    </div>
                )}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-start gap-4">
                                        {/* Subject Icon Circle */}
                                        <div className={`flex h-[56px] w-[56px] shrink-0 items-center justify-center   rounded-[10px] text-[22px] font-bold tracking-tighter border transition-colors ${
                                            isFullyCompleted
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <div className="flex items-start justify-between gap-2">
                                                ...
                                                <div className="flex flex-col items-end gap-1.5 shrink-0">
                                                    {isFullyCompleted ? (
                                                        <span className="   rounded-[10px] px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider border bg-emerald-50 text-emerald-600 border-emerald-200">
                                                            {t('Syllabus Done')}
                                                        </span>
                                                    ) : (
                                                        <span className={`   rounded-[10px] px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider border ${theme.badgeBg} ${theme.badgeText} ${theme.showBorder ? 'border-red-200' : 'border-transparent'}`}>
                                                            {t(theme.label)}
                                                        </span>
                                                    )}
                                                    {s.code && (
                                            ...
                                            <div className="mt-2 h-2 w-full overflow-hidden   rounded-[10px] bg-slate-100">
                                                <div 
                                                    className={`h-full   rounded-[10px] transition-all duration-500 ${theme.barColor}`}
